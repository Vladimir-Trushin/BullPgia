...
Demo.o: Demo.cpp play.hpp DummyChoosers.hpp DummyGuessers.hpp SmartGuesser.hpp Guesser.hpp
...
play.o: play.cpp play.hpp calculate.hpp Guesser.hpp
...
DummyGuessers.o: DummyGuessers.cpp DummyGuessers.hpp Guesser.hpp
	clang++-5.0 -std=c++17 --compile DummyGuessers.cpp -o DummyGuessers.o

SmartGuesser.o:  SmartGuesser.cpp SmartGuesser.hpp Guesser.hpp
	clang++-5.0 -std=c++17 --compile SmartGuesser.cpp -o SmartGuesser.o

clean:
	rm -f DummyGuessers.o DummyChoosers.o calculate.o play.o Test.o Demo.o demo test SmartGuesser.o
